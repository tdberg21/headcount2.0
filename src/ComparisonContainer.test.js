...
describe('Comparison Container tests', () => {
  ...
  it('matches the snapshot when no cards have been clicked', () => {
    const mockArray = [];
    const wrapper = shallow(<ComparisonContainer cardsToCompare={mockArray} />);
  ...
  it('displays a card in the comparison container when a district card is clicked on', () => {
    const mockDistrict = {
      'ACADEMY 20':
        { 2004: 0.307, 2005: 0.267, 2006: 0.354, 2007: 0.392, 2008: 0.385, 2009: 0.39, 2010: 0.436, 2011: 0.489, 2012: 0.479, 2013: 0.488, 2014: 0.49 }
    };
  ...
  it('displays 2 district cards and 1 comparison card in the comparison container when two district cards  have been clicked', () => {
    const mockDistrict1 = {
      'ACADEMY 20':
